        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2023, 6, 14, 8, 37, 49, 243, DateTimeKind.Local).AddTicks(4009)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInCategorys", x => new { x.ProductId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b993b2be-4591-4ec9-b319-5fab47ded296"), "980cadc1-61a3-4398-8e62-5f362e65272f", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUserRoles",
                columns: new[] { "UserId", "RoleId" },
                values: new object[] { new Guid("ffba58d7-2f16-4902-a35d-d5a0cf3b417c"), new Guid("b993b2be-4591-4ec9-b319-5fab47ded296") });

            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("ffba58d7-2f16-4902-a35d-d5a0cf3b417c"), 0, "e668cd12-72f4-4965-b15b-bc44a3281e77", new DateTime(1996, 10, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "nguyencongdanh2410@gmail.com", true, "Danh", "Nguyen", false, null, "nguyencongdanh2410@gmail.com", "admin", "AQAAAAEAACcQAAAAELujt7jgTr2KqMUW5eR7tN6oP8BDbZmBLqrnGV0t9ixgux59jU2dG2PBhF7RbUw73g==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 6, 14, 8, 37, 49, 259, DateTimeKind.Local).AddTicks(6294), 100000m, 200000m });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInCategorys_CategoryId",
                table: "ProductInCategorys",
                column: "CategoryId");
